...
class GoogleFootballMultiAgentEnv(object):
    ...
    def get_obs(self, index=-1):
        ...
        if index == -1:
            ...
            obs_left_team_pos = full_obs['left_team'][-self.nagents:]
            gate_relative = np.array([1,0]) - full_obs['left_team'][-self.nagents:]
...
def make_football_env_3vs4_BackBall(seed,dense_reward=False, dump_freq=1000,render=False):
    '''
    ...
    '''
    return GoogleFootballMultiAgentEnv(seed,dense_reward, dump_freq,render=render)
