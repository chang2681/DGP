...
def get_common_args():
    ...
    parser.add_argument('--ac_seq', type=int, default=8)  # 0 leader-follower ; 1 每个智能体一个； 2 没有局部q函数
    parser.add_argument('--lf_q', type=int,default=1,
    ...
    #parser.add_argument('--alg', type=str, default='CDS')
    parser.add_argument('--alg', type=str, default='qplex')

    parser.add_argument('--other_label', action='store_true',
                        default='tt')  # _extra

    ################pac_men#########
    # parser.add_argument('--beta1', type=float, default=.05)
    # parser.add_argument('--beta2', type=float, default=.5)
    # parser.add_argument('--beta', type=float, default=.002)#.01
    # parser.add_argument('--beta3', type=float, default=1)
    # # ###################GRF#############
    # # #
    parser.add_argument('--beta1', type=float, default=.5)  # .5
    parser.add_argument('--beta2', type=float, default=.5)  # 2.
    parser.add_argument('--beta', type=float, default=.06)
    ...
    parser.add_argument('--adv_hypernet_layers', type=int, default=2)  #####1
    ...
    # Ours+QPLEX
    parser.add_argument('--epsilon_anneal_time', type=int, default=500000)  # 500000
